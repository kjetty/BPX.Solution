//This file is auto generated on 1/30/2022 2:12:33 PM
...
{ 
	...
	{ 
		...
		{ 
			...
			{ 
				public const int Create = 26; 			 //Root.Menu.Create
				public const int Delete = 29; 			 //Root.Menu.Delete
				public const int Filter = 31; 			 //Root.Menu.Filter
				public const int List = 30; 			 //Root.Menu.List
				public const int ListDeleted = 32; 			 //Root.Menu.ListDeleted
				public const int Read = 27; 			 //Root.Menu.Read
				public const int Undelete = 33; 			 //Root.Menu.Undelete
				public const int Update = 28; 			 //Root.Menu.Update
			} 

			public static class MenuPermit
			{ 
				public const int CRUD = 36; 			 //Identity.MenuPermit.CRUD
			} 
			...
			{ 
				...
				public const int Undelete = 25; 			 //Identity.Permit.Undelete
			...
			{ 
				...
				public const int Undelete = 17; 			 //Identity.Role.Undelete
				public const int Update = 12; 			 //Identity.Role.Update
			} 

			public static class RolePermit
			{ 
				public const int CRUD = 35; 			 //Identity.RolePermit.CRUD
			} 
			...
			{ 
				public const int CRUD = 34; 			 //Identity.UserRole.CRUD
			} 
